...
object NavPayload {
    ...
    fun encode(payload: FileNavPayload): String {
        return json.encodeToString(FileNavPayload.serializer(), payload)
    }

    fun decode(encoded: String): FileNavPayload {
        return json.decodeFromString(FileNavPayload.serializer(), Uri.decode(encoded))
    }
}
